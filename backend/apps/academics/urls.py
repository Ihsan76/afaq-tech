...
urlpatterns = [
    ...
    path('tracks/', views.AcademicTrackListView.as_view(), name='track-list'),
    path('tracks/create/', views.AcademicTrackCreateView.as_view(), name='track-create'),
    path('tracks/<int:pk>/', views.AcademicTrackDetailView.as_view(), name='track-detail'),
