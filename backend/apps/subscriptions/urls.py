...
urlpatterns = [
    ...
    path('admin/currencies/', views.AdminCurrencyListCreateView.as_view(), name='admin-currency-list'),
    path('admin/currencies/<int:pk>/', views.AdminCurrencyDetailView.as_view(), name='admin-currency-detail'),
