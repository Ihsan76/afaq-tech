...
urlpatterns = [
    ...
    path('orders/<int:pk>/checkout/', views.order_checkout, name='order-checkout'),
    ...
    path('payments/webhook/stripe/', views.payment_webhook, {'provider': 'stripe'}, name='stripe-webhook'),
    path('payments/webhook/myfatoorah/', views.payment_webhook, {'provider': 'myfatoorah'}, name='myfatoorah-webhook'),
    path('payments/webhook/', views.payment_webhook, {'provider': 'stripe'}, name='payment-webhook'),
