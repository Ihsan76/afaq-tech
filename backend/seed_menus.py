...
sidebar_items = [
    ...
    {"menu": "sidebar", "service_context": ["school"], "required_role": ["school_admin"], "translations": {"en": {"title": "Grades"}, "ar": {"title": "الصفوف الدراسية"}}, "url": "/school/admin/grades", "icon": "📚", "order": 11, "is_active": True},
    {"menu": "sidebar", "service_context": ["school"], "required_role": ["school_admin"], "translations": {"en": {"title": "Teachers"}, "ar": {"title": "المعلمون"}}, "url": "/school/admin/teachers", "icon": "👨‍🏫", "order": 12, "is_active": True},
    {"menu": "sidebar", "service_context": ["school"], "required_role": ["school_admin"], "translations": {"en": {"title": "Sections & Students"}, "ar": {"title": "الشعب والطلاب"}}, "url": "/school/admin/sections", "icon": "🏫", "order": 13, "is_active": True},
    {"menu": "sidebar", "service_context": ["school"], "required_role": ["school_admin"], "translations": {"en": {"title": "Rooms"}, "ar": {"title": "القاعات والمختبرات"}}, "url": "/school/admin/rooms", "icon": "🏛️", "order": 14, "is_active": True},
