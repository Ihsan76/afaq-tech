          ...
          <table className="w-full">
            <thead>
              <tr className="border-b" style={{ borderColor: "var(--color-border)", background: "var(--color-surface-alt)" }}>
                <th className="col-hide-sm px-4 py-4"></th>
                <th className="px-4 py-4 text-right text-sm font-bold" style={{ color: "var(--color-text-secondary)" }}>{t("admin.title")}</th>
                <th className="col-hide-md px-4 py-4 text-center text-sm font-bold" style={{ color: "var(--color-text-secondary)" }}>{t("admin.level")}</th>
                <th className="col-hide-md px-4 py-4 text-center text-sm font-bold" style={{ color: "var(--color-text-secondary)" }}>{t("admin.chapters")}</th>
            ...
            <tbody>
              {courses.map((course) => (
                <tr key={course.id} className="border-b transition-colors hover:opacity-90" style={{ borderColor: "var(--color-border)" }}>
                  <td className="col-hide-sm px-4 py-4">
                    {course.thumbnail ? (
                  ...
                  <td className="col-hide-md px-4 py-4 text-center text-xs" style={{ color: "var(--color-text-secondary)" }}>{t(`courses.${course.level}`)}</td>
                  <td className="col-hide-md px-4 py-4 text-center text-sm" style={{ color: "var(--color-text-secondary)" }}>{course.lessons_count}</td>
