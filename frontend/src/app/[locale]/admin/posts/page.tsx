          ...
          <table className="w-full">
            <thead>
              <tr className="border-b" style={{ borderColor: "var(--color-border)", background: "var(--color-surface-alt)" }}>
                <th className="col-hide-sm px-6 py-4 text-right text-sm font-bold" style={{ color: "var(--color-text-secondary)" }}></th>
                <th className="px-6 py-4 text-right text-sm font-bold" style={{ color: "var(--color-text-secondary)" }}>{t("admin.title") || "Title"}</th>
                <th className="col-hide-md px-6 py-4 text-right text-sm font-bold" style={{ color: "var(--color-text-secondary)" }}>{t("admin.category") || "Category"}</th>
                <th className="col-hide-md px-6 py-4 text-center text-sm font-bold" style={{ color: "var(--color-text-secondary)" }}>{t("admin.readTime") || "Read"}</th>
                <th className="col-hide-sm px-6 py-4 text-center text-sm font-bold" style={{ color: "var(--color-text-secondary)" }}>{t("admin.views") || "Views"}</th>
            ...
            <tbody>
              {posts.map((post) => (
                <tr key={post.id} className="border-b transition-colors hover:opacity-90" style={{ borderColor: "var(--color-border)" }}>
                  <td className="col-hide-sm px-6 py-4">
                  ...
                  <td className="col-hide-md px-6 py-4 text-sm" style={{ color: "var(--color-text-secondary)" }}>
                    {post.category_name ? localized(post.category_name, locale, "name") : "—"}
                  </td>
                  <td className="col-hide-md px-6 py-4 text-center text-sm" style={{ color: "var(--color-text-secondary)" }}>{post.read_time}m</td>
                  <td className="col-hide-sm px-6 py-4 text-center text-sm" style={{ color: "var(--color-text-secondary)" }}>{post.views}</td>
