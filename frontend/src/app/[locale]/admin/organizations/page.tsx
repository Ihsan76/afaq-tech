              ...
              <table className="w-full">
                <thead className="sticky top-0" style={{ background: "var(--color-surface)" }}>
                  <tr>
                    ...
                    <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{t("admin.organizationOwnerEmail")}</th>
                    <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{t("admin.organizationPlan")}</th>
                    <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{t("admin.organizationExtraSeats")}</th>
                    ...
                    <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{t("admin.organizationMembers")}</th>
                ...
                <tbody style={{ borderTop: "1px solid var(--color-border)" }}>
                  {orgs.map((org) => (
                    <tr key={org.id} style={{ borderTop: "1px solid var(--color-border)" }}>
                      ...
                      <td className="px-6 py-4 text-sm" style={{ color: "var(--color-text-secondary)" }}>{org.owner_email}</td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 font-mono text-sm" style={{ color: "var(--color-text-secondary)" }}>+{org.extra_seats}</td>
                      <td className="px-6 py-4">
