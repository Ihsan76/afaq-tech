...
const LABELS: Record<string, Record<string, string>> = {
  ...
  gradesTab: { ar: "🎓 الصفوف", en: "🎓 Grades", fr: "🎓 Niveaux", tr: "🎓 Sınıflar", ur: "🎓 جماعتیں", es: "🎓 Grados", de: "🎓 Klassenstufen", id: "🎓 Kelas", bn: "🎓 শ্রেণী" },
  documentsTab: { ar: "📄 المستندات", en: "📄 Documents", fr: "📄 Documents", tr: "📄 Belgeler", ur: "📄 دستاویزات", es: "📄 Documentos", de: "📄 Dokumente", id: "📄 Dokumen", bn: "📄 নথি" },
  curriculaDesc: { ar: "إدارة المناهج الدراسية وربطها بالصفوف", en: "Manage curricula and link them to grades", fr: "Gérer les programmes et les lier aux niveaux", tr: "Müfredatı yönetin ve sınıflara bağlayın", ur: "نصاب کا نظم کریں اور جماعتوں سے منسلک کریں", es: "Gestionar planes de estudio y vincularlos a grados", de: "Lehrpläne verwalten und mit Klassenstufen verknüpfen", id: "Kelola kurikulum dan hubungkan ke kelas", bn: "পাঠ্যক্রম পরিচালনা করুন এবং শ্রেণীর সাথে লিঙ্ক করুন" },
  gradesDesc: { ar: "إدارة الصفوف الدراسية", en: "Manage grades", fr: "Gérer les niveaux", tr: "Sınıfları yönetin", ur: "جماعتوں کا نظم کریں", es: "Gestionar grados", de: "Klassenstufen verwalten", id: "Kelola kelas", bn: "শ্রেণী পরিচালনা করুন" },
  ...
  language: { ar: "اللغة", en: "Language", fr: "Langue", tr: "Dil", ur: "زبان", es: "Idioma", de: "Sprache", id: "Bahasa", bn: "ভাষা" },
  name: { ar: "الاسم", en: "Name", fr: "Nom", tr: "Ad", ur: "نام", es: "Nombre", de: "Name", id: "Nama", bn: "নাম" },
  country: { ar: "الدولة", en: "Country", fr: "Pays", tr: "Ülke", ur: "ملک", es: "País", de: "Land", id: "Negara", bn: "দেশ" },
  year: { ar: "السنة", en: "Year", fr: "Année", tr: "Yıl", ur: "سال", es: "Año", de: "Jahr", id: "Tahun", bn: "বছর" },
  grade: { ar: "الصف", en: "Grade", fr: "Niveau", tr: "Sınıf", ur: "جماعت", es: "Grado", de: "Klassenstufe", id: "Kelas", bn: "শ্রেণী" },
  level: { ar: "المستوى", en: "Level", fr: "Niveau", tr: "Seviye", ur: "سطح", es: "Nivel", de: "Stufe", id: "Tingkat", bn: "স্তর" },
  nameAr: { ar: "الاسم (عربي)", en: "Name (Arabic)", fr: "Nom (Arabe)", tr: "Ad (Arapça)", ur: "نام (عربی)", es: "Nombre (Árabe)", de: "Name (Arabisch)", id: "Nama (Arab)", bn: "নাম (আরবি)" },
  nameEn: { ar: "English", en: "English", fr: "Anglais", tr: "İngilizce", ur: "انگریزی", es: "Inglés", de: "Englisch", id: "Inggris", bn: "ইংরেজি" },
  addGrade: { ar: "إضافة صف", en: "Add Grade", fr: "Ajouter un niveau", tr: "Sınıf Ekle", ur: "جماعت شامل کریں", es: "Agregar grado", de: "Klassenstufe hinzufügen", id: "Tambah Kelas", bn: "শ্রেণী যোগ করুন" },
  addCurriculum: { ar: "إضافة منهج", en: "Add Curriculum", fr: "Ajouter un programme", tr: "Müfredat Ekle", ur: "نصاب شامل کریں", es: "Agregar plan de estudios", de: "Lehrplan hinzufügen", id: "Tambah Kurikulum", bn: "পাঠ্যক্রম যোগ করুন" },
  editGrade: { ar: "تعديل الصف", en: "Edit Grade", fr: "Modifier le niveau", tr: "Sınıfı Düzenle", ur: "جماعت میں ترمیم", es: "Editar grado", de: "Klassenstufe bearbeiten", id: "Edit Kelas", bn: "শ্রেণী সম্পাদনা করুন" },
  editCurriculum: { ar: "تعديل المنهج", en: "Edit Curriculum", fr: "Modifier le programme", tr: "Müfredatı Düzenle", ur: "نصاب میں ترمیم", es: "Editar plan de estudios", de: "Lehrplan bearbeiten", id: "Edit Kurikulum", bn: "পাঠ্যক্রম সম্পাদনা করুন" },
  levelOrder: { ar: "المستوى (ترتيب)", en: "Level (Order)", fr: "Niveau (Ordre)", tr: "Seviye (Sıra)", ur: "سطح (ترتیب)", es: "Nivel (Orden)", de: "Stufe (Reihenfolge)", id: "Tingkat (Urutan)", bn: "স্তর (ক্রম)" },
  filledCount: { ar: "تم تعبئة {n} من {t} لغات", en: "{n} of {t} languages filled", fr: "{n} sur {t} langues remplies", tr: "{t} dilden {n} dolduruldu", ur: "{t} زبانوں میں سے {n} بھری گئیں", es: "{n} de {t} idiomas completados", de: "{n} von {t} Sprachen ausgefüllt", id: "{n} dari {t} bahasa diisi", bn: "{t}টি ভাষার মধ্যে {n}টি পূরণ করা হয়েছে" },
  saving: { ar: "جار الحفظ...", en: "Saving...", fr: "Enregistrement...", tr: "Kaydediliyor...", ur: "محفوظ ہو رہا ہے...", es: "Guardando...", de: "Speichern...", id: "Menyimpan...", bn: "সংরক্ষণ করা হচ্ছে..." },
  save: { ar: "حفظ", en: "Save", fr: "Enregistrer", tr: "Kaydet", ur: "محفوظ کریں", es: "Guardar", de: "Speichern", id: "Simpan", bn: "সংরক্ষণ করুন" },
  cancel: { ar: "إلغاء", en: "Cancel", fr: "Annuler", tr: "İptal", ur: "منسوخ کریں", es: "Cancelar", de: "Abbrechen", id: "Batal", bn: "বাতিল করুন" },
  uploadDocument: { ar: "رفع مستند", en: "Upload Document", fr: "Télécharger un document", tr: "Belge Yükle", ur: "دستاویز اپ لوڈ کریں", es: "Subir documento", de: "Dokument hochladen", id: "Unggah Dokumen", bn: "নথি আপলোড করুন" },
  uploading: { ar: "جار الرفع...", en: "Uploading...", fr: "Téléchargement...", tr: "Yükleniyor...", ur: "اپ لوڈ ہو رہا ہے...", es: "Subiendo...", de: "Hochladen...", id: "Mengunggah...", bn: "আপলোড হচ্ছে..." },
  uploadBtn: { ar: "رفع المستند", en: "Upload Document", fr: "Télécharger", tr: "Belge Yükle", ur: "دستاویز اپ لوڈ کریں", es: "Subir documento", de: "Dokument hochladen", id: "Unggah Dokumen", bn: "নথি আপলোড করুন" },
  title: { ar: "العنوان", en: "Title", fr: "Titre", tr: "Başlık", ur: "عنوان", es: "Título", de: "Titel", id: "Judul", bn: "শিরোনাম" },
  subject: { ar: "المادة", en: "Subject", fr: "Matière", tr: "Ders", ur: "مضمون", es: "Materia", de: "Fach", id: "Mata Pelajaran", bn: "বিষয়" },
  subjectOptional: { ar: "المادة (اختياري)", en: "Subject (Optional)", fr: "Matière (Optionnelle)", tr: "Ders (İsteğe Bağlı)", ur: "مضمون (اختیاری)", es: "Materia (Opcional)", de: "Fach (Optional)", id: "Mata Pelajaran (Opsional)", bn: "বিষয় (ঐচ্ছিক)" },
  file: { ar: "الملف", en: "File", fr: "Fichier", tr: "Dosya", ur: "فائل", es: "Archivo", de: "Datei", id: "Berkas", bn: "ফাইল" },
  ...
  docPlaceholder: { ar: "اسم المستند", en: "Document name", fr: "Nom du document", tr: "Belge adı", ur: "دستاویز کا نام", es: "Nombre del documento", de: "Dokumentname", id: "Nama dokumen", bn: "নথির নাম" },
  ...
  selectCurrHint: { ar: "اختر منهجاً من القائمة أعلاه لإدارة مستنداته", en: "Select a curriculum from the list above to manage its documents", fr: "Sélectionnez un programme dans la liste pour gérer ses documents", tr: "Belgelerini yönetmek için yukarıdaki listeden bir müfredat seçin", ur: "اس کی دستاویزات کا نظم کرنے کے لیے اوپر کی فہرست سے ایک نصاب منتخب کریں", es: "Seleccione un plan de estudios de la lista para gestionar sus documentos", de: "Wählen Sie einen Lehrplan aus der Liste aus, um seine Dokumente zu verwalten", id: "Pilih kurikulum dari daftar di atas untuk mengelola dokumennya", bn: "এর নথি পরিচালনা করতে উপরের তালিকা থেকে একটি পাঠ্যক্রম নির্বাচন করুন" },
  noGrades: { ar: "لا توجد صفوف دراسية بعد", en: "No grades yet", fr: "Aucun niveau pour le moment", tr: "Henüz sınıf yok", ur: "ابھی کوئی جماعت نہیں", es: "Sin grados todavía", de: "Noch keine Klassenstufen", id: "Belum ada kelas", bn: "এখনও কোন শ্রেণী নেই" },
  addGradesHint: { ar: "أضف الصفوف من تأسيسي (تمهيدي، أول ... سنة 6 جامعة)", en: "Add grades from Foundation (KG, Grade 1 ... University Year 6)", fr: "Ajoutez les niveaux de la Fondation (Maternelle, CP ... Doctorat)", tr: "Temelden itibaren sınıfları ekleyin (Anaokulu, 1. Sınıf ... Üniversite 6)", ur: "بنیادی سے جماعتیں شامل کریں (کے جی، پہلی جماعت ... یونیورسٹی سال 6)", es: "Agregue grados desde Fundación (Preescolar, 1er Grado ... Año 6 Universidad)", de: "Fügen Sie Klassenstufen von der Grundstufe hinzu (Vorschule, 1. Klasse ... Universität 6. Jahr)", id: "Tambahkan kelas dari Fondasi (TK, Kelas 1 ... Universitas Tahun 6)", bn: "ভিত্তি থেকে শ্রেণী যোগ করুন (কেজি, প্রথম শ্রেণী ... বিশ্ববিদ্যালয় ৬ষ্ঠ বর্ষ)" },
  confirmDeleteGrade: { ar: "تأكيد حذف هذا الصف؟", en: "Confirm delete this grade?", fr: "Confirmer la suppression de ce niveau?", tr: "Bu sınıfı silmek istediğinize emin misiniz?", ur: "اس جماعت کو حذف کرنے کی تصدیق کریں؟", es: "¿Confirmar eliminación de este grado?", de: "Löschen dieser Klassenstufe bestätigen?", id: "Konfirmasi hapus kelas ini?", bn: "এই শ্রেণী মুছে ফেলার নিশ্চিতকরণ?" },
  confirmDeleteDoc: { ar: "تأكيد حذف هذا المستند؟", en: "Confirm delete this document?", fr: "Confirmer la suppression de ce document?", tr: "Bu belgeyi silmek istediğinize emin misiniz?", ur: "اس دستاویز کو حذف کرنے کی تصدیق کریں؟", es: "¿Confirmar eliminación de este documento?", de: "Löschen dieses Dokuments bestätigen?", id: "Konfirmasi hapus dokumen ini?", bn: "এই নথি মুছে ফেলার নিশ্চিতকরণ?" },
  reqNameAr: { ar: "الاسم بالعربية مطلوب", en: "Arabic name is required", fr: "Le nom en arabe est requis", tr: "Arapça ad gerekli", ur: "عربی نام ضروری ہے", es: "El nombre en árabe es obligatorio", de: "Arabischer Name erforderlich", id: "Nama Arab wajib diisi", bn: "আরবি নাম প্রয়োজন" },
  reqTitleFile: { ar: "العنوان والملف مطلوبان", en: "Title and file are required", fr: "Titre et fichier requis", tr: "Başlık ve dosya gerekli", ur: "عنوان اور فائل ضروری ہیں", es: "Título y archivo obligatorios", de: "Titel und Datei erforderlich", id: "Judul dan berkas wajib diisi", bn: "শিরোনাম এবং ফাইল প্রয়োজন" },
  deleteFailed: { ar: "فشل الحذف", en: "Delete failed", fr: "Échec de la suppression", tr: "Silme başarısız", ur: "حذف ناکام ہوا", es: "Error al eliminar", de: "Löschen fehlgeschlagen", id: "Gagal menghapus", bn: "মুছে ফেলা ব্যর্থ হয়েছে" },
  uploadFailed: { ar: "فشل الرفع", en: "Upload failed", fr: "Échec du téléchargement", tr: "Yükleme başarısız", ur: "اپ لوڈ ناکام ہوا", es: "Error al subir", de: "Hochladen fehlgeschlagen", id: "Unggah gagal", bn: "আপলোড ব্যর্থ হয়েছে" },
  loading: { ar: "جار التحميل...", en: "Loading...", fr: "Chargement...", tr: "Yükleniyor...", ur: "لوڈ ہو رہا ہے...", es: "Cargando...", de: "Laden...", id: "Memuat...", bn: "লোড হচ্ছে..." },
};
                ...
                <table className="w-full">
                  <thead style={{ backgroundColor: "var(--color-background-secondary)" }}>
                    <tr>
                      ...
                      <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{al(locale, "country")}</th>
                      <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{al(locale, "year")}</th>
                      ...
                      <table className="w-full">
                        <thead className="sticky top-0" style={{ background: "var(--color-surface)" }}>
                          <tr>
                            ...
                            <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{al(locale, "dateUploaded")}</th>
                  ...
                  <table className="w-full">
                    <thead className="sticky top-0" style={{ background: "var(--color-surface)" }}>
                      <tr>
                        ...
                        <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{al(locale, "nameEn")}</th>
                        <th className="px-6 py-4 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--color-text-muted)" }}>{t("common.actions")}</th>
                      </tr>
                    </thead>
                    <tbody style={{ borderTop: "1px solid var(--color-border)" }}>
                      {grades.sort((a, b) => a.level - b.level).map((g) => (
                        <tr key={g.id} style={{ borderTop: "1px solid var(--color-border)" }}>
                          ...
                          <td className="px-6 py-4" style={{ color: "var(--color-text-muted)" }}>{g.translations?.en?.name || "-"}</td>
                          <td className="px-6 py-4 flex gap-3">
